...
set structure=http://www.macaulay.ac.uk/obiama/ontologies/SimpleExample6.owl
set schedule=http://www.macaulay.ac.uk/obiama/ontologies/SimpleExample6-Schedule.owl
set schedinst=%schedule%#schedule
set initinst=%schedule%#initialisation

set cmd=java -classpath %cp% uk.ac.macaulay.obiama.model.RepastModel --ontology %structure% --initial-schedule %initinst% --schedule %schedule% --main-schedule %schedinst% --ontology-search-path %cwd%;%cwd%\..\..\ontologies --log SimpleExample2.log --save-dir %cwd%\output --use-reasoner --save-inferred
